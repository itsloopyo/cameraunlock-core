...
const mutations = [
  ...
  ["no final CRLF", base.slice(0, -2), "line 79 does not end in CRLF"],
  ["LF throughout", base.replace(/\r\n/g, "\n"), "lines 1, 2, 3 and 76 more do not end in CRLF"],
  ...
  ["a repeated section", append(["[hotkeys]", "ZoomKey=F5"]), "line 81: [hotkeys] repeats the section begun on line 66"],
  ...
  ["[Sensitivity]", append(["[Sensitivity]", "Deadband=1"]), "line 81: [Sensitivity] holds no canonical setting"],
  ["[Reticle]", append(["[Reticle]"]), "line 81: [Reticle] holds no canonical setting"],
  ["a bare noun", append(["[Flashlight]", "Enabled=true"]), "line 82: [Flashlight] Enabled: a bare Enabled"],
  ["a snake_case key", append(["[Camera]", "yaw_limit=90"]), "line 82: [Camera] yaw_limit is not a PascalCase name"],
  ["a lower-case section", append(["[target]", "CbSize=4"]), "line 81: [target] is not a PascalCase name"],
  ["a key in two sections", append(["[Camera]", "Offset=1", "[Debug]", "Offset=2"]), "line 84: [Debug] Offset: Offset is also a key under [Camera]"],
