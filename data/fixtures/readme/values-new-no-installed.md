The mod reads its settings from `CameraUnlock.ini`. It sits in the folder the plugin loader names. It creates the file when it starts and finds none. Edit it with any text editor.
